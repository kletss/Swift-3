...
//
    ...
    override func viewDidLoad() {
        ...
        NetworkService().getListGroups() {
            [weak self] vkGroups in self?.vkGroups = vkGroups
...
// //       cell.imageView?.image = myGroups[indexPath.item].image
        cell.configate(imageUrl: vkGroups.items[indexPath.item].groupAvatarURL, name: vkGroups.items[indexPath.item].name)
