...
//    lazy var indMax = frendCollectionImag[indFrendCollectionImag].images.count - 1
    lazy var indMax = vkPhotos.items.count - 1
...
//        self.frendImageOld.image = frendCollectionImag[indFrendCollectionImag].images[indImage]
        let cc = vkPhotos.items[indImage].sizes.count-1
        self.frendImageOld.image = urlToImage(urlImage: vkPhotos.items[indImage].sizes[cc].urlImage)
...
//            self.frendImage.image = frendCollectionImag[indFrendCollectionImag].images[indImageT]
            var cc = vkPhotos.items[indImageT].sizes.count-1
            self.frendImage.image = urlToImage(urlImage: vkPhotos.items[indImageT].sizes[cc].urlImage)
...
//            self.frendImageLeft.image = frendCollectionImag[indFrendCollectionImag].images[indImageT]
            cc = vkPhotos.items[indImageT].sizes.count-1
            self.frendImageLeft.image = urlToImage(urlImage: vkPhotos.items[indImageT].sizes[cc].urlImage)
                ...
                if let swipe = recognizer as? UISwipeGestureRecognizer {
                    ...
                    switch swipe.direction {
                        case .right:
                            ...
                            if !(indImage < 0) {
//                                self.frendImage.image = frendCollectionImag[indFrendCollectionImag].images[indImage]
                                self.frendImage.image = urlToImage(urlImage: vkPhotos.items[indImage].sizes[0].urlImage)
...
//                            let indMax = frendCollectionImag[indFrendCollectionImag].images.count - 1
                            let indMax = vkPhotos.items.count - 1
